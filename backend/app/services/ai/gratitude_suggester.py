...
FALLBACK_OPTIONS: dict[str, list[str]] = {
    "people": [
        ...
        "My closest person",
        "Someone who taught me patience",
        "A warm welcome",
    ...
    "health": [
        ...
        "A pain that finally eased",
        "Medicine that helped",
        "A walk that cleared my head",
        "Hands that work",
        "A good appetite",
        "Rest after being tired",
    ...
    "experiences": [
        ...
        "Time that flew by",
        "A perfect playlist",
        "A surprise that delighted me",
        "A quiet evening in",
        "A talk into the night",
        "A creative spark",
        "A moment of pure joy",
        "A new place explored",
        "A game with friends",
        "A story well told",
        "Getting carried away laughing",
    ],
    "growth": [
        "A small win today",
        "Something I learned",
        ...
        "A promise I kept",
        "Learning to wait",
        "Choosing differently this time",
    ],
    "home": [
        ...
        "A warm bath",
        "A houseplant thriving",
        "The first coffee in my kitchen",
        "A clean countertop",
        "The sound of the kettle",
        "A safe place to sleep",
        "Morning light in a room",
    ...
    "simple_pleasures": [
        ...
        "The first bite of something good",
        "A clean kitchen",
        "A warm towel",
        "A quiet road",
        "A soft pillow",
        "Birdsong in the morning",
        "A short, restful break",
    ...
    "small_moments": [
        ...
        "A song ending right on time",
        "A passing kindness",
        "A glimpse of open sky",
        "A warm hand to hold",
        "A quiet elevator ride",
        "A coincidence that helped",
        "A small, happy surprise",
        "A pause to just breathe",
    ...
    "big_moments": [
        ...
        "A first step somewhere new",
        "A goodbye that taught me",
        "A reunion",
        "Finishing something huge",
        "A second chance",
        "A defining choice",
    ...
    "spiritual": [
        ...
        "Deep, quiet gratitude",
        "A glimpse of something eternal",
        "Peace after a storm",
        "Faith in hard times",
        "A connection beyond words",
        "A sense of belonging",
        "Stillness that healed",
    ...
    "material": [
        ...
        "A comfortable chair",
        "A coat that keeps me warm",
        "A roof that doesn't leak",
        "A working car",
        "Lights that turn on",
        "A meal I didn't worry about",
        "A phone to reach people",
        "Money for a small joy",
        "Sturdy shoes",
        "A warm blanket",
