...
export const JOURNAL_PROMPTS: JournalPrompt[] = [
  // Gratitude
  { text: "What's one small thing you're grateful for right now?", textJa: 'いま、感謝できるちいさなことは？', theme: 'gratitude' },
  ...
  { text: 'What about your body are you quietly thankful for today?', textJa: '今日、自分のからだのどこに、そっと感謝している？', theme: 'gratitude' },

  // Reflection on practice
  { text: 'How did your practice feel today — in body, in mind?', textJa: '今日のプラクティスは——からだで、心で、どんな感じ？', theme: 'practice' },
  { text: 'Was there a moment of stillness today, however brief?', textJa: 'たとえ一瞬でも、静けさの瞬間はあった？', theme: 'practice' },
  { text: 'What did you notice during or after your sit?', textJa: '瞑想の最中や、そのあとに気づいたことは？', theme: 'practice' },
  { text: 'Did anything come up during practice that surprised you?', textJa: 'プラクティス中に、驚いたことはあった？', theme: 'practice' },
  ...
  { text: "Is there something you're avoiding feeling? What's underneath it?", textJa: '感じるのを避けているものは？その奥には何が？', theme: 'emotional' },
  { text: "What would you say to a friend feeling what you're feeling right now?", textJa: '同じ気持ちでいる友だちに、あなたなら何と声をかける？', theme: 'emotional' },

  // Intention
  { text: "What's one intention you want to carry into tomorrow?", textJa: '明日へ持っていきたい、ひとつの意図は？', theme: 'intention' },
  { text: 'What does "enough" look like for you today?', textJa: 'あなたにとって「これで十分」とは、今日どんな姿？', theme: 'intention' },
