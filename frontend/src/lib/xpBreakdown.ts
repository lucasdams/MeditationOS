 ...
 *
 * `activityLabel` names the thing the user just did (e.g. "🙏 Gratitude"). The activity
 * XP is the remainder after subtracting newly-completed quests and the streak-bonus
 * change, so it stays correct even as XP rules are tuned.
 */
