...
const BODY_SCAN: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Rest in awareness of your whole body, all at once. Nothing to change.', bell: true, weight: 3 },
    { cue: "When you're ready, take one fuller breath and let your eyes open.", bell: false, weight: 2 },
  ],
}
...
const LOVING_KINDNESS: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'May all beings be safe, be well, be happy, and live with ease.', bell: false, weight: 3 },
    // Close
...
const NAME_FEELINGS: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: "Notice — you can name a feeling and hold it without it taking you over.", bell: false, weight: 2 },
...
const SAVORING: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Bring to mind something good in your life right now. A person, a comfort, a simple pleasure — small is fine.', bell: true, weight: 3 },
...
const JUST_SIT: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Nothing needs to happen. This IS the practice.', bell: true, weight: 3 },
...
const PMR: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Rest in the looseness left behind. Nothing to hold.', bell: false, weight: 3 },
...
const COUNT_BREATH: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'When you lose the count — and you will — simply begin again at one.', bell: true, weight: 4 },
    { cue: "Losing count isn't failure. Noticing you lost it is the practice.", bell: false, weight: 3 },
    { cue: 'No need to reach ten cleanly. Small numbers, kept, are plenty.', bell: false, weight: 2 },
    { cue: 'Let the counting steady you. One breath, one number, then the next.', bell: true, weight: 3 },
...
const NOTING: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: "Notice the tiny gap the word creates. You're aware of it, not lost in it.", bell: true, weight: 3 },
    { cue: 'If several things arise at once, just note the loudest. "Planning." "Restless."', bell: false, weight: 3 },
    { cue: 'No need to catch everything. Note what you catch, and let the rest go by.', bell: false, weight: 2 },
...
const SOUND_BATH: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Let sounds arise and fade on their own. Nothing to hold onto.', bell: false, weight: 3 },
...
const GRATITUDE_SIT: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Start with the body. It has carried you through this whole day without being asked. Feel the breath arriving, all on its own.', bell: true, weight: 3 },
    { cue: 'Bring to mind a person who supports you — who\'s kind to you, roots for you, or simply shows up. Picture their face.', bell: true, weight: 3 },
...
const WIND_DOWN: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Softening. Nothing to do.', bell: false, weight: 2 },
  ],
}
...
const FOUR_SEVEN_EIGHT: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Empty your lungs completely with one long, quiet sigh out.', bell: true, weight: 1 },
...
const SET_DOWN_DAY: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Anything still pulling at you? Name it once, and set it down too.', bell: false, weight: 3 },
...
const PHYSIOLOGICAL_SIGH: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Breathe in through your nose… then, on top, sip in a little more air.', bell: true, weight: 3 },
    { cue: "Now let it all go — a long, slow exhale through the mouth, until you're empty.", bell: true, weight: 3 },
    ...
    { cue: 'Now let the breath return to normal. Notice how you feel — a little steadier.', bell: false, weight: 2 },
  ],
}
...
const STEADY_SENSES: GuidedStructure = {
  ...
  phases: [
    ...
    { cue: 'Now four things you can feel. Your feet in your shoes, the chair, the air on your skin, the weight of your hands.', bell: true, weight: 3 },
    { cue: 'Three things you can hear. Near and far — a hum, a voice, your own breath. Just notice them.', bell: true, weight: 2 },
    { cue: 'Two things you can smell — or two slow breaths through your nose if nothing\'s there.', bell: true, weight: 2 },
