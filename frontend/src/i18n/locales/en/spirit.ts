...
export const spirit: Record<string, string> = {
  ...
  'spirit.option.storm_peak': 'Storm peak',
  'spirit.option.neon_city': 'Neon city',
  'spirit.option.volcano': 'Volcano',
  'spirit.option.cosmic_void': 'Cosmic void',
  'spirit.option.dojo': 'Dojo',
  'spirit.option.zen_garden': 'Zen garden',
  'spirit.option.sakura': 'Sakura',
  'spirit.option.arcade': 'Arcade',
  'spirit.option.underwater': 'Underwater',
  'spirit.option.kawaii': 'Happy face',
  'spirit.option.wink': 'Wink',
  'spirit.option.lashes': 'Lashes',
  'spirit.option.tongue': 'Tongue out',
  'spirit.option.frogface': 'Frog face',
  'spirit.option.starry': 'Star eyes',
  'spirit.option.sleepy': 'Sleepy',
  'spirit.option.surprised': 'Surprised',
  'spirit.option.hearts': 'Heart eyes',
  'spirit.option.cool': 'Sunglasses',
  'spirit.option.firefly': 'Firefly',
  'spirit.option.bird': 'Bird',
  'spirit.option.cat': 'Cat',
  'spirit.option.phoenix': 'Phoenix',
  'spirit.option.koi': 'Koi fish',
  'spirit.option.jellyfish': 'Jellyfish',
  'spirit.option.luna_moth': 'Luna moth',
  ...
  'spirit.option.hoverboard': 'Hoverboard',
  ...
  'spirit.option.bubbles': 'Floating bubbles',
  'spirit.option.confetti': 'Confetti',
  'spirit.option.meteor_shower': 'Meteor shower',
  ...
  'spirit.option.snow_bank': 'Snow bank',
  'spirit.option.lava_rock': 'Lava rock',
  'spirit.option.neon_grid': 'Neon grid',
  ...
  'spirit.option.duckling': 'Duckling',
  'spirit.option.axolotl': 'Axolotl',
  'spirit.option.boba': 'Bubble tea',
  'spirit.option.capybara': 'Capybara',
  'spirit.option.wired_earbuds': 'Wired earbuds',
  'spirit.option.cat_ears': 'Cat ears',
  'spirit.option.bucket_hat': 'Bucket hat',
  'spirit.option.hot_spring': 'Hot spring',
  'spirit.option.mushroom': 'Mushroom',
  'spirit.option.hedgehog': 'Hedgehog',
  'spirit.option.penguin': 'Penguin',
  'spirit.option.shiba': 'Shiba',
  'spirit.option.beret': 'Beret',
  'spirit.option.flower_crown': 'Flower crown',
  'spirit.option.heartfall': 'Drifting hearts',
  'spirit.option.campsite': 'Campsite',
  'spirit.option.onsen_towel': 'Onsen towel',
  'spirit.option.yuzu': 'Yuzu',
  'spirit.option.otter': 'Otter',
  'spirit.option.red_panda': 'Red panda',
  'spirit.option.bamboo_grove': 'Bamboo grove',
  'spirit.option.spring_stones': 'Spring stones',
  'spirit.option.steam': 'Rising steam',
  'spirit.option.tanuki': 'Tanuki',
  'spirit.option.snow_monkey': 'Snow monkey',
  'spirit.option.teahouse': 'Tea house',
