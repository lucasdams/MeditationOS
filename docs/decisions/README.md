...
| [0029](0029-spirit-tamagotchi.md) | The spirit becomes a Tamagotchi — real-time need decay, sickness, and death from neglect (reverses the 0022/0023 non-punishing core; supersedes the 0025/0026/0028 needs-modifiers) | Accepted (point 4 refined by 0030) |
| [0030](0030-spirit-rebirth-from-a-spark.md) | Rebirth from a spark — growth (stage / level / unlock gates) derives from the spirit's own life (XP since awakened); death is a true restart; coins stay an account budget (no migration) | Accepted |
