...
**Status:** Cycles 1–4 complete — auth, session tracking, a stats dashboard, guided HRV breathing, an unguided meditation timer, an AI gratitude tool, and daily quests/XP working locally · 105 backend tests passing · Cycle 5 (AWS deploy) up next
...
- 🌱 Sanctuary (in progress) — a garden you grow by practicing: plants grow from your practice and you **choose what to grow next** (tree · flower · pond, milestone-unlocked), on a dedicated page with a completion celebration; Phases 1–3 built. See [Sanctuary design](docs/design/sanctuary.md)
...
- ✅ 105 backend tests (pytest against Postgres), CI on every PR, Dockerized dev stack, security review actioned
