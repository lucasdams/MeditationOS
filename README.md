...
- 🌱 Sanctuary (in progress) — a garden you grow by practicing: plants across **nature, structures & companions** grow from your practice and you **choose what to grow next** (milestone-unlocked by points or a streak), with a streak-driven **vitality**, on a dedicated page with a completion celebration; Phases 1–4 built. See [Sanctuary design](docs/design/sanctuary.md)
