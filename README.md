...
- ✅ 189 backend tests (pytest against Postgres) + frontend tests (Vitest + Testing Library), CI on every PR, Dockerized dev stack, security review actioned
